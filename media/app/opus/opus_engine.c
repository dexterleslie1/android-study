...
Java_com_future_android_study_media_OpusEngine_open(JNIEnv *env,jobject thiz,jint compression){
    int err;
...
JNIEXPORT
jint JNICALL Java_com_future_android_study_media_OpusEngine_getFrameSize(JNIEnv *env,jobject thiz) {
    return  FRAME_SIZE;
}

//压缩
JNIEXPORT
jint JNICALL Java_com_future_android_study_media_OpusEngine_encode(
        JNIEnv *env,
        jobject thiz,
        jshortArray lin,
        jint offset,
...
//解压
JNIEXPORT
jint JNICALL Java_com_future_android_study_media_OpusEngine_decode(
        JNIEnv *env,
        jobject thiz,
        jbyteArray encoded,
        jshortArray lin,
...
Java_com_future_android_study_media_OpusEngine_close(JNIEnv *env,jobject thiz){
    if(encoder){
